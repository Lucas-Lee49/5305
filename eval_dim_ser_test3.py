...
parser.add_argument("--model_path", type=str, default="./model/weight_cat_ser")
...
ssl_model = AutoModel.from_pretrained("/root/autodl-tmp/MSP-Podcast_Challenge/prewavlm")
